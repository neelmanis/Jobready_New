...
<div class="inner_conainer" >
	...
	<div class="other_exam">General Exam Result</div>
		...
		?>
                ...
                <div class="menuheader expandable"><strong>Test <strong><?php echo $i;?></strong></strong></div>
		...
		?>
				<div class="main_accord">
                <div class="menuheader expandable"><strong>Test <?php echo $j;?></strong></div>
                <div class="categoryitems accord_detail">
