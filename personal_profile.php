          ...
          <div>
            <div class="quest_box fade_anim">
              <div class="info_wrap">
                ...
                </div>				<div class="info">                  <div class="head">CV</div>                  <div class="dvdr">:</div>                  <div class="det"><a href="upload/cv/<?php echo $registration_id;?>/<?php echo ucfirst($row['upload_cv']);?>" target="_blank"/>Download CV</a>				  </div>                </div>
                <div class="clear"></div>
              </div>
              <div class="add_info">
