...
$neelxz=" SELECT `id`, `area_of_interest`,`admin_trainer_name`, `description`, `doc`, `status` FROM `job_training_list` WHERE `id`= $getuid";
...
$trainer_name=$mysqlrow['admin_trainer_name'];
...
$new1="UPDATE `job_training_list` SET `modified_date`=NOW(),`area_of_interest`='$aoi',`admin_trainer_name`='$admin_trainer_name',`description`='$description',`status`='$status' WHERE `id`= $getuid"; 
