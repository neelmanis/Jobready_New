...
if(empty($title)) 
{ $signup_error="Please Choose Name";}
elseif(empty($file_name)) 
{ $signup_error="Please Choose Images";}
...
$neelx="INSERT INTO `master_success_story`(`id`, `post_date`,`title`, `image`, `desc`, `status`) VALUES ('',NOW(),'$title','$img','$content','$status')";
...
<span class="glyphicon glyphicon-user"></span>&nbsp;Add Story <?php if(isset($signup_error)){ echo '<span style="color: red;" />'.$signup_error.'</span>';} ?></h4>
...
<i class="icon-save"></i>&nbsp;Add Story</button>
</form>        
</div>
<!-- ckeditor script -->
<script>
