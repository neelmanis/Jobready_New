...
<?php $userx="SELECT `id`, `subject`,`status` FROM `master_area_of_interest` WHERE 1";$result = mysql_query($userx)or die(mysql_error());while($row=mysql_fetch_array($result)){//print_r($row);$getid=$row['id']; ?>
<tr>
