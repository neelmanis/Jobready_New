...
$neelx="INSERT INTO `cms_sh_articles`(`id`, `post_date`,`title`, `image`, `desc`, `status`) VALUES ('',NOW(),'$title','$img','$content','$status')";
...
<span class="glyphicon glyphicon-user"></span>&nbsp;Add Articles <?php if(isset($signup_error)){ echo '<span style="color: red;" />'.$signup_error.'</span>';} ?></h4>
...
<i class="icon-save"></i>&nbsp;Add Article</button>
</form>        
</div>
<!-- ckeditor script -->
<script>
