...
<?php
$neelxz="SELECT `id`,`title`, `desc`, `status` FROM `cms_editor` WHERE `id`= $skwid";
...
$new1="UPDATE `cms_editor` SET `modified_date`=NOW(),`title`='$title',`desc`='$content',`status`='$status' WHERE `id`= $skwid";
...
<span class="glyphicon glyphicon-user"></span>&nbsp;Soft skills at Work<?php if(isset($signup_error)){ echo '<span style="color: red;" />'.$signup_error.'</span>';} ?></h4>
