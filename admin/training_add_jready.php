...
$sql="INSERT INTO `job_training_list`(`id`, `registration_id`, `admin_id`, `area_of_interest`,`admin_trainer_name`, `description`, `doc`, `post_date`,`status`) VALUES ('','','$gotuid','$aoi','$trainer_name','$description','$img',NOW(),'$status')";
...
<b>Trainer Name :</b> <input type="text" class="form-control" name="trainer_name" value="<?php echo $trainer_name;?>" Placeholder="Please Enter Trainer Name" required/>
...
<?php
$neelxz="SELECT `id`,`area_of_interest`, `status` FROM `master_interest_area` WHERE `is_compulsory`='0' and status='1' ORDER BY area_of_interest ASC";
