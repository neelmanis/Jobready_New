...
<div class="inner_conainer" >
	...
	<input type="button" onclick="location.href='online_exam.php';" value="ONLINE TEST">
    	...
    	<div class="arrowlistmenu"> 
		   ...
		   <?php
				$neelx=$conn->query("select attempt_id from scores where user_id='$registration_id' group by attempt_id");
			...
			?>
				...
				//echo "select * from scores where attempt_id='$attempt_id' and user_id='$registration_id'";
				$neely=$conn->query("select * from scores where attempt_id='$attempt_id' and user_id='$registration_id'");
				...
				<div class="exam_score">	
					<div class="subject">
						<?php //echo $getSubjectName($conn,$subject_id); ?><span><?php echo $right_per; ?>%</span>
					</div>
					<div class="range">
						<div class="percentage sub_1" style="width:<?php echo $right_per;?>%;"></div>
					</div>
				</div>	
				<?php }	?>
                </div>
