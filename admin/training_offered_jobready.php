...
$neelx="SELECT `id`, `area_of_interest`, `admin_trainer_name`,`description`, `doc`, `post_date`, `status` FROM `job_training_list` WHERE admin_id='$gotuid'";
...
<td><?php echo $row['admin_trainer_name']; ?></td>
