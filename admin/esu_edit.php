...
<?php
$neelxz="SELECT * FROM `cms_editor` WHERE `id`= $getuid";
...
$new1="UPDATE `cms_editor` SET `modified_date`=NOW(),`title`='$title',`desc`='$content',`status`='$status' WHERE `id`= $getuid";
...
<span class="glyphicon glyphicon-user"></span>&nbsp;Update Employment Scenario Updates <?php if(isset($signup_error)){ echo '<span style="color: red;" />'.$signup_error.'</span>';} ?></h4>
