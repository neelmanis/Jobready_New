    ...
    <div class="dashboard_right fade_anim">
    	<div class="dashbox_wrap">
         	<div class="dashbox blue_bg">
                ...
                <a class="more" href="personal_profile.php"></a>
            </div>
            ...
            <div class="dashbox green_bg">
				...
				<?php
				$neelx=$conn->query("SELECT sum(`total_marks_obtain`) as `mark_obtain`,sum(`total_marks`) as `total_marks` FROM `scores` WHERE `registration_id`=45 group by attempt_id order by attempt_id desc limit 1");
				$num1=$neelx->num_rows;
				...
				<div class="test_result">
                	<span><?php echo ceil($mark_per); ?>%</span>
                    <!--<div class="range"><div class="percentage"></div></div>-->
					 <div class="range"><div class="percentage sub_1" style="width:<?php echo $mark_per; ?>%;"></div></div>
                </div> 
				<?php } else {?>   
                 <div class="test_result">
				 	<span>You Haven't Attempted Any Exams Yet..!</span>
                 </div>   
				<?php } ?>				
                <a class="more" href="exam_score.php"></a>
            </div>
            ...
            <div class="dashbox red_bg">
               ...
               <?php }?>
                ...
                <a class="more" href="personal_trainings.php"></a>
            </div>
