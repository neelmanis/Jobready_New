...
<div class="inner_conainer">
	<div class="trainer_feedback">
        ...
        <div class="profile_detail">
        	<div class="name">Aniket Shinde</div>
            <span>Banking</span>
            <p>Mumbai Area, IndiaindustryBanking</p>
            
            <p>&nbsp;</p>	
            <ul class="contact">
            <li><img src="images/icon_phone.png" /> 09821642627</li>
            <li><img src="images/icon_mail.png" /> <a href="mailto:shindeaniket251@gmail.com">shindeaniket251@gmail.com</a></li>
        </ul>
    ...
    <div class="trainer_feedback">
        ...
        <div class="info_wrap">
                        ...
                        <div class="info">
                            ...
                            <div class="dvdr">:</div>
                            <div class="det">Male</div>
                        </div>
                        <div class="info">
                            <div class="head">mobile number</div>
                            <div class="dvdr">:</div>
                            <div class="det">0987654321</div>
                        </div>
                        <div class="info">
                            <div class="head">DOB</div>
                            <div class="dvdr">:</div>
                            <div class="det">22/01/1984</div>
                        </div>
                        
                        <div class="info">
                            <div class="head">Preferred Locations</div>
                            <div class="dvdr">:</div>
                            <div class="det">Mumbai</div>
                        </div>
    ...
    <div class="trainer_feedback">
        ...
        <div class="rating_wrap">
            <div class="rating_left">
                ...
                <div class="rating_box my_rate no_anim">
                    <div class="rate_it" data="0_1"></div> 
                </div>
            </div>
