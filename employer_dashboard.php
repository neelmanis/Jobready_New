...
/*  Get total no of people interest */
$results=$conn->query("select COUNT(id) as total from job_student_job_interest where `employer_registraion_id`='$registration_id'");
$row1=$results->fetch_assoc();
$total_interest=$row1['total'];
/*  Get total no of interview */
$result2=$conn->query("select COUNT(id) as total from job_student_job_interest where `candidate_interviewed`='Y' and `employer_registraion_id`='$registration_id'");
  ...
  <div class="dashboard_right fade_anim">
    <div class="dashbox_wrap">
      <div class="dashbox blue_bg">
        ...
        <a class="more" href="employer_profile.php"></a> </div>
      ...
      <div class="dashbox red_bg">
        ...
        <a class="more" href="employer_training_offered.php"></a> </div>
    </div>
  </div>
  <div class="clear"></div>
</div>
