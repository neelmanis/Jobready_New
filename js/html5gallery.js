...
function loadHtml5Gallery(r) {
        ...
        j = u.drag = {
            ...
            hijack: function(c, e, a, d, b) {
                if (a) {
                    ...
                    a.results = [];
                    do
                        if ((q = a.interactions[x]) && !("dragend" !== e && q.cancelled)) g = j.properties(c, a, q), q.results = [], l(b || q[f] || a.droppable).each(function(b, d) {
    ...
    g.fn.addHTML5VideoControls = function(c, e) {
        ...
        if (k.get(0).volume === u / 2 + 0.1) {
            k.get(0).volume = u;
            var u = g(".html5boxVolume", t),
                F = g(".html5boxVolumeButton", t),
                K = g(".html5boxVolumeBar", t),
                w = g(".html5boxVolumeBarBg", t),
        ...
        e.prototype = {
            ...
            createStyleVertical: function() {
                ...
                var b = b + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" + this.options.boxLeft + "px; top:" + this.options.boxTop + "px; width:" + this.options.boxWidth + "px; height:" + this.options.boxHeight + "px; }"),
                    ...
                    b = b + (" .html5gallery-viral-" +
                        this.id + " {display:block; overflow:hidden; position:absolute; text-align:left; top:" + d + "px; left:0px; width:" + this.options.boxWidth + "px; height:" + this.options.socialheight + "px; padding-top:" + e + "px;}"),
                ...
                if ("never" != this.options.showimagetoolbox) {
                    ...
                    if ("center" == this.options.imagetoolboxstyle) a = " .html5gallery-toolbox-" + this.id + " {display:none; overflow:hidden; position:relative; margin:0px auto; text-align:center; height:40px;}",
                        ...
                        var d = Math.round(("bottom" == this.options.headerpos ? 0 : this.options.headerHeight) + this.options.height / 2 - 24),
                            b = d + Math.round(this.options.height / 2) - 24,
            ...
            createStyleDefault: function() {
                ...
                var b = b + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" + this.options.boxLeft + "px; top:" + this.options.boxTop + "px; width:" + this.options.boxWidth + "px; height:" + this.options.boxHeight +
                    ...
                    b = b + (" .html5gallery-title-" + this.id + " {display:" + (this.options.titleoverlay && this.options.titleautohide ? "none" : "block") + "; overflow:hidden; position:absolute; left:0px; width:" + this.options.boxWidth + "px; "),
                    b = this.options.titleoverlay ?
                    "top" == this.options.headerpos ? b + "top:0px; height:auto; }" : b + "bottom:0px; height:auto; }" : b + ("top:" + a + "px; height:" + this.options.titleheight + "px; }"),
                    b = b + (" .html5gallery-timer-" + this.id + " {display:block; position:absolute; top:" + String(this.options.elemTop + this.options.height - 2) + "px; left:0px; width:0px; height:2px; background-color:#ccc; filter:alpha(opacity=60); opacity:0.6; }"),
                    b = b + (" .html5gallery-elem-" + this.id + " {display:block; overflow:hidden; position:absolute; top:" + this.options.elemTop +
                ...
                for (var b = 0; b < this.elemArray.length; b++) {
                    ...
                    c(e).load(function() {
                        var b = Math.max(a.options.thumbimagewidth / this.width, a.options.thumbimageheight / this.height),
                            ...
                            m = a.options.thumbshowplayonvideo && 1 != a.elemArray[this.data][9] ? "<div class='html5gallery-tn-img-play-" + a.id + "' style='display:block; overflow:hidden; position:absolute; width:" + a.options.thumbimagewidth + "px;height:" + a.options.thumbimageheight + "px; top:" + a.options.thumbimageborder + "px; left:" + a.options.thumbimageborder + 'px;background:url("' + a.options.skinfolder + "playvideo.png\") no-repeat center center;'></div>" : "";
            ...
            resizeFullscreen: function() {
                ...
                var a = c(window).width(),
                    e = Math.max(b, c(document).height()),
                    d = c(window).scrollTop() + Math.round((b - (d + 2 * this.fullscreenMargin + this.fullscreenBarH)) / 2);
            ...
            goFullscreen: function() {
                ...
                1 > e && (a *= e, d *= e);
                var e = Math.max(c(window).width(), c(document).width()),
                    h = Math.max(b, c(document).height()),
                    b = c(window).scrollTop() + Math.round((b - (d + 2 * this.fullscreenMargin + this.fullscreenBarH)) / 2);
            ...
            showImage: function() {
                ...
                c(b).load(function() {
                    ...
                    var f = d.isFullscreen ? e : d.options.width,
                        n = d.isFullscreen ? b : d.options.height,
            ...
            adjustFullscreen: function(a, d, b) {
                var e = window.innerHeight ? window.innerHeight : c(window).height(),
                    e = c(window).scrollTop() + Math.round((e - (d + 2 * this.fullscreenMargin + this.fullscreenBarH)) / 2);
            ...
            showPoster: function() {
                ...
                c(f).load(function() {
                    ...
                    var r = Math.round(g / 2 - l / 2),
                        s = Math.round(j / 2 - f / 2);
        ...
        this.each(function() {
            ...
            var j = {
                ...
                q = {
                    ...
                    freeversion: !0,
                    freemark: "jobready",
                    freelink: "http://jobready/html5gallery/watermark.php",
                    watermark: ""
                },
            ...
            if (-1 != this.options.htmlfolder.indexOf("://jobready") || -1 != this.options.htmlfolder.indexOf("://www.jobready")) this.options.freeversion = !1;
            d = c(window).width();
            if (this.options.screenquery)
                for (var p in this.options.screenquery) d <= this.options.screenquery[p].screenwidth && (this.options.screenquery[p].gallerywidth &&
